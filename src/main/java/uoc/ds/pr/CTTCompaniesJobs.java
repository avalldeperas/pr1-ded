...
public interface CTTCompaniesJobs {
     ...
     */
    void addWorker(String id, String name, String surname, LocalDate dateOfBirth, Qualification qualification);
     ...
     */
    void addCompany(String id, String name, String description);
     ...
     */
    void addRequest(String id, String jobOfferId, String companyId, String description,
     ...
     */
    Request updateRequest(Status status, LocalDate date, String description) throws NoRequestException;
     ...
     */
    Response signUpJobOffer(String workerId, String jobOfferId) throws JobOfferNotFoundException, WorkerNotFoundException, WorkerAlreadyEnrolledException;
     ...
     */
    Iterator<JobOffer> getJobOffersByCompany(String companyId) throws NOJobOffersException;
     ...
     * If they do not exist, the error will be reported.
     */
    Iterator<JobOffer> getAllJobOffers() throws NOJobOffersException;
     ...
     */
    Iterator<JobOffer> getJobOffersByWorker(String workerId) throws NOJobOffersException;
     ...
     */
    void addRating(String workerId, String jobOfferId, int value, String message) throws WorkerNotFoundException, JobOfferNotFoundException, WorkerNOEnrolledException;
     ...
     */
    Iterator<Rating> getRatingsByJobOffer(String jobOfferId) throws JobOfferNotFoundException, NORatingsException;
     ...
     */
    Worker getMostActiveWorker() throws NoWorkerException;
     ...
     * If it does not exist, the error will be reported.
     */
    JobOffer getBestJobOffer() throws NOJobOffersException;
